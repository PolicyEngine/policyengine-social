...
class BlogImageExtractor:
    def __init__(self, blog_slug: str):
        self.slug = blog_slug
        self.app_repo = "https://raw.githubusercontent.com/PolicyEngine/policyengine-app/master"
    ...
    def auto_select_images(self, images: Dict, platform: str) -> List[str]:
        ...
        if platform == 'x':
            ...
            supporting = [k for k, v in images.items() 
                         if v['type'] == 'supporting'][:3]
...
def main():
    ...
    parser.add_argument('--optimize', choices=['x', 'linkedin'],
